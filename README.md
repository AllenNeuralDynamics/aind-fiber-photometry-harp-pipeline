...
The [fiber photometry pipeline](https://codeocean.allenneuraldynamics.org/capsule/9110101/tree) runs on [Nextflow](https://www.nextflow.io/) and contains the following steps:

* [aind-fip-harp-nwb-base-capsule](https://github.com/AllenNeuralDynamics/aind-fip-harp-nwb-base-capsule): FiberPhotometry Capsule which appends to an NWB subject file. Currently in development for new standard
...
* [aind-fip-harp-qc-raw](https://github.com/AllenNeuralDynamics/aind-fip-harp-raw-qc): QC capsule for raw fiber photometry data.
...
* `aind`: The pipeline outputs are saved under the `results` top-level folder with JSON files following [aind-data-schema](https://github.com/AllenNeuralDynamics/aind-data-schema). The folders are shown below:
